// ------------------ WashRequestTabs.jsx (conditional buttons by tabIndex) ------------------
...
function WashRequestTabs({
    ...
    }, [filters?.startTime, filters?.endTime, filters?.status, onSearch]);
...
export default WashRequestTabs;
