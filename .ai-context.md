...
export async function handleVoice(message: VoiceMessage, context: HandlerContext) // [logic hidden]
      ...
      type: "tool",
      type: "tool",
async function handleText(text: string, languageCode: string | undefined, context: HandlerContext) // [logic hidden]
...
### 📄 src/constants/damageAssessment.js
```javascript
/**
...
### 📄 src/context/DcidContext.jsx
```javascript
import React, {
import { getDcid, setDcid as setDcidStore, initDcid } from "../state/dcidStore";
export function DcidProvider({ children }) // [logic hidden]
export function useDcid() // [logic hidden]
```

### 📄 src/helpers/HelpersPage.jsx
```javascript
...
export default function HelpersPage() // [logic hidden]
```

### 📄 src/helpers/InventoryStatusUpdateModule.jsx
```javascript
...
import {
export default function InventoryStatusUpdateModule() // [logic hidden]
```

### 📄 src/helpers/PopulateDeliveryItemsModule.jsx
```javascript
...
export default function PopulateDeliveryItemsModule() // [logic hidden]
```

### 📄 src/helpers/RfidScanPage.jsx
```javascript
import { useCallback, useState } from "react";
import {
import ContentCopyIcon from "@mui/icons-material/ContentCopy";
...
import { formatHelperApiError } from "./formatHelperApiError";
import { helperService } from "../services/helperService";
export default function RfidScanPage() // [logic hidden]
```

### 📄 src/helpers/formatHelperApiError.js
```javascript
export function formatHelperApiError(error) // [logic hidden]
```

### 📄 src/helpers/inventoryStatusUpdateConfig.js
```javascript
export function parseInventoryIds(value) // [logic hidden]
export function validateForm(formValues) // [logic hidden]
export function buildPayload(formValues, parsedInventoryIds) // [logic hidden]
```

### 📄 src/helpers/rfidHelpers.js
```javascript
export function parseTags(input) // [logic hidden]
export function resolvePrefix(tag) // [logic hidden]
export function validateTag(tag) // [logic hidden]
function randomRssi() // [logic hidden]
function formatTimestamp() // [logic hidden]
export function buildPayload(validItems) // [logic hidden]
```
...
import { billingService } from "../services/billingService";
export function useBillingCycles(params) // [logic hidden]
export function useBillingCycleDetails(id) // [logic hidden]
export function useBillingPreferences(params) // [logic hidden]
export function useCreateBillingPreference() // [logic hidden]
export function useUpdateBillingPreference() // [logic hidden]
export function useProcessOrdersToBillable() // [logic hidden]
export function useGenerateInvoiceForBillingCycle() // [logic hidden]
export function useGenerateInvoices() // [logic hidden]
export function useBillingCycleAnnexureUrl() // [logic hidden]
export function useLockBillingCycle() // [logic hidden]
```
...
import { useQueryClient } from "@tanstack/react-query";
export function useDamageRequests(params) // [logic hidden]
export function useDamageRequest(id) // [logic hidden]
export function useCreateDamageRequest() // [logic hidden]
export function useUpdateDamageRequest() // [logic hidden]
export function useApproveDamageRequest() // [logic hidden]
export function useRejectDamageRequest() // [logic hidden]
...
export function useDeleteDamageRequest() // [logic hidden]
```
...
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { scannerService } from "../services/scannerService";
export function useScanners() // [logic hidden]
export function useActiveScanSession(readerId) // [logic hidden]
export function useStartScan() // [logic hidden]
export function useStopScan() // [logic hidden]
export function useCancelScan() // [logic hidden]
```
 ...
 */
export function useWebSocket() // [logic hidden]
```
...
### 📄 src/models/BillingPreference.js
```javascript
...
### 📄 src/services/agreementService.jsx
```javascript
...
function isPlainObjectData(data) // [logic hidden]
function addToGetParams(config, key, value) // [logic hidden]
function addToBody(config, key, value) // [logic hidden]
function injectValue(config, metaKey, paramKey, getterFn) // [logic hidden]
```
...
### 📄 src/services/customerUserService.jsx
```javascript
import api from './apiService.jsx';
```

### 📄 src/services/damageAssessmentService.jsx
```javascript
import api from "./apiService";
import { ItemDamageRequest } from "../models/ItemDamageRequest";
```

### 📄 src/services/dcService.jsx
```javascript
import api from './apiService.jsx';
```

### 📄 src/services/helperService.jsx
```javascript
import api from "./apiService";
```
...
### 📄 src/services/inventorySummaryService.jsx
```javascript
import api from './apiService.jsx';
function getStoredInwardRequests() // [logic hidden]
function saveInwardRequests(list) // [logic hidden]
```
...
### 📄 src/services/inwardRequestService.jsx
```javascript
import api from './apiService';
```
...
### 📄 src/services/laundryUserService.jsx
```javascript
import api from './apiService';
```

### 📄 src/services/laundryVendorService.jsx
```javascript
import api from './apiService.jsx'; 
```
...
### 📄 src/services/processingService.jsx
```javascript
import api from './apiService';
```
...
### 📄 src/services/reservationService.jsx
```javascript
import api from './apiService';
```

### 📄 src/services/routeService.jsx
```javascript
import api from './apiService.jsx'; 
```

### 📄 src/services/scannerService.jsx
```javascript
import api from "./apiService";
```

### 📄 src/services/scannerSocketService.jsx
```javascript
...
### 📄 src/services/soiledService.jsx
```javascript
import api from "./apiService";
```

### 📄 src/services/tripService.jsx
```javascript
import api from './apiService.jsx';
```
...
### 📄 src/services/vendorService.jsx
```javascript
import api from './apiService';
```

### 📄 src/services/washFulfillmentService.jsx
```javascript
import api from './apiService.jsx';
import { getApiHeaders } from '../utils/apiHeaders';
```

### 📄 src/services/washRequestService.jsx
```javascript
import api from './apiService.jsx';
import { getApiHeaders } from '../utils/apiHeaders';
```

### 📄 src/state/dcidStore.js
```javascript
export function initDcid() // [logic hidden]
export function getDcid() // [logic hidden]
export function setDcid(next) // [logic hidden]
```
...
### 📄 src/utils/ visitItemStatus.js
```javascript
import {
```

### 📄 src/utils/CopyInventoryButton.jsx
```javascript
import { useState } from 'react';
...
export default function CopyInventoryButton({ items }) // [logic hidden]
```

### 📄 src/utils/createColumn.js
```javascript
    type = "text",
    type,
```
 ...
 */
function getTodayRangeISO() // [logic hidden]
/** Helper: safe array */
/**
 ...
 */
function getCategoryCodeFromItem(item) // [logic hidden]
/**
 * API adapters
 * Adjust endpoint paths if your existing services already provide methods.
 */
async function fetchOrdersToday({ start, end }) // [logic hidden]
async function fetchTripsToday({ start, end }) // [logic hidden]
/** Fallback: get per-trip details if search doesn’t include nested info */
async function fetchTripDetails(tripId) // [logic hidden]
async function fetchWashFulfillmentsToday({ start, end }) // [logic hidden]
function toDateOnlyLocal(dateLike) // [logic hidden]
async function fetchWashRequestsToday({ start, end }) // [logic hidden]
/**
 ...
 */
function summarizeTrips(trips) // [logic hidden]
 ...
 */
function summarizeFulfillments(list) // [logic hidden]
function summarizeWashRequests(list) // [logic hidden]
/**
 * Public API
 * Returns a single object the dashboard can consume.
 */
export async function fetchDashboardData({ start, end } = {}) // [logic hidden]
```
...
export function formatDateLabel(input, pattern = "do MMM, yyyy") // [logic hidden]
export function parseDate(dateString, inputDateTimezone = DATE_PARSE_MODE) // [logic hidden]
export function formatCustomDate(date, options = DATE_ONLY) // [logic hidden]
export function formatDateForApi(date) // [logic hidden]
export function formatDateForTimestamp(date) // [logic hidden]
export function getDayRange(date, offsetDays = 0) // [logic hidden]
/**
 ...
 */
export function generateMonthOptions(count = 24) // [logic hidden]
/**
 ...
 */
export function getMonthRange(monthStr) // [logic hidden]
```
...
### 📄 src/utils/pendingItemsTransformer.js
```javascript
function getLastNDays(n = 7) // [logic hidden]
export function buildPendingItemsIndex(washRequests, days = 7) // [logic hidden]
```

### 📄 src/utils/poolTransformers.js
```javascript
export function transformPools(data) // [logic hidden]
export function transformPoolsWithProducts(data) // [logic hidden]
```

### 📄 src/utils/productColorRegistry.js
```javascript
function generateHslColor(index) // [logic hidden]
export function getProductColor(productId) // [logic hidden]
```

### 📄 src/utils/reservationTransformers.js
```javascript
export function reservationTransformers(reservations = []) // [logic hidden]
```

### 📄 src/utils/scanSound.js
```javascript
/**
 ...
 */
function getAudioContext() // [logic hidden]
function playBeep() // [logic hidden]
function playChime() // [logic hidden]
function playPop() // [logic hidden]
function playKaching() // [logic hidden]
function playOnce() // [logic hidden]
/**
...
export function getScanSoundType() // [logic hidden]
/**
 ...
 */
export function playAllSounds() // [logic hidden]
 ...
 */
export function playScanSound(count = 1) // [logic hidden]
/**
 ...
 * @returns {number}
 */
export function countScannedItems(msg) // [logic hidden]
```
 ...
 */
function disableConsoleOutput() // [logic hidden]
function showWarningBanner() // [logic hidden]
function startDebuggerTraps() // [logic hidden]
function blockKeyboardShortcuts() // [logic hidden]
function disableRightClick() // [logic hidden]
export function initSecurity() // [logic hidden]
```

### 📄 src/utils/statusUtils.js
```javascript
export function getStatusChipColor(status) // [logic hidden]
export function mapStatusesToChipColors(statuses) // [logic hidden]
```

### 📄 src/utils/washRequestTransformers.js
```javascript
function clone(value) // [logic hidden]
function renameFieldsInWashRequest(originalWashRequest) // [logic hidden]
function renameFieldsInFulfillmentSummary(originalFulfillmentSummary) // [logic hidden]
  function renameKeys(targetObj, keyMap) // [logic hidden]
function mergeFulfillmentTotalsIntoRequest(originalWashRequest, originalFulfillmentSummary) // [logic hidden]
function addProductSoiledItemsTotals(originalWashRequest) // [logic hidden]
function addWashDaysToWashRequest(originalWashRequest, originalFulfillmentSummary) // [logic hidden]
function transformWashRequestAndFulfillment(originalWashRequest, originalFulfillmentSummary) // [logic hidden]
```

### 📄 src/utils/workReport/sheet1.js
```javascript
import { formatDateDMY, pickCounts } from './helpers';
export function populateSheet1(ws, data) // [logic hidden]
...
### 📄 src/utils/workReport/sheet2.js
```javascript
import { formatDateDMY, pickCounts, pickPickupCounts } from './helpers';
export function populateSheet2(ws, data) // [logic hidden]
    const headerFill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEFEFEF' } };
    const zebraFill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFF8F8F8' } };
        const totalFill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFFFF2CC' } };
```

### 📄 src/utils/workReport.js
```javascript
...
export async function downloadWorkReportXLSX(orders, fileName = 'work-report.xlsx') // [logic hidden]
