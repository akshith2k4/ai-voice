 ...
 */
export function buildWalkthroughPrompt(schema: FormSchema, currentFieldKey: string): string // [logic hidden]
 ...
 */
export async function executeAutoResume(context: HandlerContext): Promise<void> // [logic hidden]
